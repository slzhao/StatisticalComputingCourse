...
Is the mean value of age in this data different than 10?
...
statistic: the value of the t test statistics parameter: the degrees of
freedom for the t test statistics p.value: the p-value for the test
conf.int: a confidence interval for the mean appropriate to the
specified alternative hypothesis. estimate: the means of the two groups
being compared (in the case of independent t test) or difference in
means (in the case of paired t test).
...
Is the mean value of fev between smokers and non-smokers different?
...
Let's compare the RBD value bewteen Baseline and three weeks following
first vaccine dose: *rbd1* ELISA response to RBD at baseline *rbd2*
ELISA response to RBD three weeks following first vaccine dose
...
***organ:*** organ type (0 = healthy control, 1 = kidney, 2 = liver, 3 =
heart, 4 = lung).
