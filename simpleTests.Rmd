...
-   Motivation
-   One sample inference on means
-   One sample inference on propotions
-   Two-sample inference on means (independant)
-   Two-sample inference on propotions (independant)
