...
boxplot(fev$fev~fev$smoke, main="", ylab="FEV", xlab="Smoker")
...
Kruskal-Wallis test is a non-parametric alternative to one-way ANOVA test, which extends Wilcoxon test rank sum test when there are more than two groups.
